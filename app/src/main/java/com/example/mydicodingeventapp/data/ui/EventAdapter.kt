...
import com.example.mydicodingeventapp.databinding.EventListRowBinding

class EventAdapter : ListAdapter<ListEventsItem, EventAdapter.MyViewHolder> (DIFF_CALLBACK){


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding = EventListRowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
